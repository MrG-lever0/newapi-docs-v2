...
description: AionUi setup guide — free, open-source desktop office agent supporting Gemini CLI, Claude Code, Codex, and more. Connect to New API for multi-model AI workflows.
---
